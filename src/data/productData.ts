...
export const products: Product[] = [
    ...
    },
    {
      ...
      brand: "کازرکس",
      category: "آرایشی",
      description: "Lorem et nisi proident duis. Irure deserunt ad magna quis. Exercitation occaecat mollit consequat ad cillum reprehenderit sint.",
      originalPrice: "989,000",
      hasDiscount: true,
    ...
    },
    {
      ...
      brand: "بالانس",
      category: "عطر",
      description: "Cillum sint adipisicing aliqua et incididunt deserunt adipisicing quis nostrud Lorem. Aute consequat voluptate consequat laborum quis elit cillum ipsum do anim sit adipisicing esse. Ut adipisicing amet occaecat minim voluptate consequat velit eiusmod mollit fugiat ea proident laboris enim. Aute sunt nisi ex mollit in reprehenderit labore elit eiusmod mollit commodo. Veniam voluptate tempor excepteur id ex proident ut voluptate nostrud duis consequat reprehenderit.",
      originalPrice: "1,490,000",
      hasDiscount: false,
      discountedPrice: "1,399,000",
      imageSrc: product2,
    ...
    },
    {
      ...
      brand: "پیورست",
      category: "مو",
      description: "Et tempor duis esse eiusmod minim. Sunt enim sint nisi tempor. Reprehenderit labore elit nulla consectetur.",
      originalPrice: "1,490,000",
      hasDiscount: false,
      discountedPrice: "1,399,000",
      imageSrc: product2,
