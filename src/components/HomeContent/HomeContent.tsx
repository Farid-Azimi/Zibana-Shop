...
const loadProductsImage = async (imageName: string) => {
  const imageModule = await import(`../../images/products/${imageName}`);
...
const products = [
  {
    ...
    imageSrc: await loadProductsImage("product1.jpg"),
  },
  {
    id: 2,
    ...
    imageSrc: await loadProductsImage("product2.jpg"),
  },
  {
    id: 3,
    name: "اسنس حلزون کازرکس (تخفیف ویژه)",
...
const loadCategoriesImage = async (imageName: string) => {
  const imageModule = await import(`../../images/categories/${imageName}`);
  return imageModule.default;
};
const categories = [
  {
    id: 1,
    name: "آرایش صورت",
    imageSrc: await loadCategoriesImage("makeup.png"),
  },
  {
    id: 2,
    name: "آرایش لب",
    imageSrc: await loadCategoriesImage("lip-stick.png"),
  },
  {
    id: 3,
    name: "لوسیون و روغن بدن",
    imageSrc: await loadCategoriesImage("body-lotion.png"),
  },
  {
    id: 4,
    name: "پاک کننده آرایش",
    imageSrc: await loadCategoriesImage("skin-care.png"),
  },
  {
    id: 5,
    name: "عطر و ادکلن",
    imageSrc: await loadCategoriesImage("perfume.png"),
  },
  {
    id: 6,
    name: "دهان و دندان",
    imageSrc: await loadCategoriesImage("mouthwash.png"),
  },
  {
    id: 7,
    name: "آرایش چشم",
    imageSrc: await loadCategoriesImage("eye-makeup.png"),
  },
];
